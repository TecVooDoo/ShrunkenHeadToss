		...
		public ScopedServiceAdder([DisallowNull] Type definingType, ServiceProviderType serviceProviderType)
		{
			...
			switch(serviceProviderType)
			{
				...
				default:
					...
					if(serviceProviderType != ServiceProviderType.None) throw new ArgumentException($"ScopedServiceAdder created for unsupported service provider type: {serviceProviderType}. Service defining type: {TypeUtility.ToString(definingType)}.", nameof(serviceProviderType));
					#endif
